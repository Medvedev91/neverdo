...
import io.neverdo.shared.getLocalUtcOffset
import kotlinx.datetime.*
import io.neverdo.shared.time

data class UnixTime(
    val time: Int = time(),
    val utcOffset: Int = getLocalUtcOffset(),
) {
    ...
    companion object {
        ...
        fun byLocalDay(localDay: Int, utcOffset: Int = getLocalUtcOffset()) =
            UnixTime(time = (localDay * 86_400) - utcOffset, utcOffset = utcOffset)

        fun byUtcTime(utcTime: Int, utcOffset: Int = getLocalUtcOffset()) =
